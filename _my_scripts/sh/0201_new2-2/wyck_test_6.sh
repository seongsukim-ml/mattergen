...
generate_and_evaluate() {
    ...
    CUDA_VISIBLE_DEVICES=$CVD uv run python scripts/generate_debug.py \
        ...
        --sampling_config_name wyck_prim_new_test \
...
generate_and_evaluate   1 1.5 1 0.0
generate_and_evaluate   1 2 1 0.0
generate_and_evaluate   1 2.5 1 0.0
